...
function getStory(storyCode) {
    switch (storyCode) {
        case 'PTIKK42SQG':
            return ['■■■ 坐在推理研究社的社辦，翻著筆電裡的照片，那是一些奇怪的身影，總是在深夜出沒於管院，從頭到腳一身黑，從沒看過其他顏色的衣服，並且在離開時一定扛著許多大型的黑色袋子和箱子。', '「肯定有問題。」■■■ 說，一邊看著照片中的神秘身影：「我一定會揪出他們的真面目！」','當初會加入推理研究社，便是由於自小對各種神秘的事件感到興趣，總是期待著自己有一天也能破解現實世界中的事件，而今在學校發現可疑的人，不免勾起 ■■■ 心中的偵探魂。'];
        case 'HS44APEBS8':
            return ['「欸我們下禮拜一要去聚餐，副社你訂一下位，晚上七點，6 個人。」社長說。', '「1, 2, 3, 4, 5…」副社數著人數「社長，我們幹部只有 5 個人欸⋯⋯」', '「咦？我怎麼會數錯？哈哈哈哈——」社長一邊大笑，心裡卻隱約覺得好像有什麼不對勁。', '「幹幹幹！忘記要開會！怎麼沒人提醒我啊！」■■■ 在崎下車站急匆匆的翻找著學生證：「吼校車要來了阿我的學生證是死去哪裡啦！」', '■■■ 一邊翻找著學生證，一邊對著公車招手，沒想到，公車司機卻彷彿沒看到他一樣，直接左轉開走了。', '「靠邀喔！」■■■ 看著開走的校車忍不住罵出了聲「媽啦，今天怎麼那麼衰？」', '■■■ 拿出手機，想到社團群組跟大家說明自己缺席的原因，殊不知，所有社群軟體、通訊軟體完全沒有他的帳號紀錄，也無法登入，■■■ 不敢相信自己的眼睛，眨了兩下眼，再定睛一看，這回卻連 SIM 卡的訊號都消失了。', '「搞屁喔！」■■■ 把手機往書包裡一丟，開始往學校的方向走。'];
        case 'APRVL69UB3':
